...
public class TripListAdapter extends RecyclerView.Adapter<TripListAdapter.ViewHolder> {
    ...
    public TripListAdapter(Context context, List<TripInfo> items) {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.start.setText( items.get(position).getStartDate() );
        holder.startTime.setText( items.get(position).getStartTime() );
        holder.end.setText( items.get(position).getEndDate() );
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            startTime = itemView.findViewById( R.id.trip_card_start_time );
            end = itemView.findViewById(R.id.trip_card_end_date);
            endTime = itemView.findViewById( R.id.trip_card_end_time );
        ...
        public void onClick(View view) {
            ...
            intent.putExtra("trip", items.get(this.getPosition()));
    ...
    private  boolean expired( int position ) {
        Date  end = DateUtil.toDate( items.get(position).getEndDate() );
